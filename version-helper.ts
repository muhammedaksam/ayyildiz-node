...
if (command === 'update') {
  ...
  if (versionPattern.test(command)) {
    ...
    console.log('Usage:');
    console.log('  npx tsx version-helper.ts show              # Show current versions');
    console.log('  npx tsx version-helper.ts version           # Show current versions');
    console.log(
      '  npx tsx version-helper.ts update            # Auto-increment patch version & commit'
    );
    console.log(
      '  npx tsx version-helper.ts update <version>  # Update to specific version & commit'
    );
    console.log(
      '  npx tsx version-helper.ts <version>         # Update to specific version & commit (legacy)'
    );
    console.log('');
    console.log('Examples:');
    console.log('  npx tsx version-helper.ts show');
    console.log('  npx tsx version-helper.ts update            # 1.0.1 → 1.0.2 & git commit');
    console.log('  npx tsx version-helper.ts update 1.1.0      # Update to 1.1.0 & git commit');
    console.log('  npx tsx version-helper.ts 1.1.0             # Update to 1.1.0 & git commit');
    console.log('');
